...
{
    public sealed class RefreshStandardBattleHudUiSystem : IEcsInitSystem, IEcsRunSystem
    {
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            {
                _uiCompositionRoot.RefreshStandardBattleHud(new StandardBattleHudViewData());
                return;
            }
            ...
            var viewData = new StandardBattleHudViewData
            {
            ...
            _uiCompositionRoot.RefreshStandardBattleHud(viewData);
        }
        ...
        private List<BattleBoardUnitViewData> BuildPlayerUnits()
        {
            ...
            for (var index = 0; index < deployedUnits.Count; index++)
            {
                ...
                deployedUnits[index].ViewData.LaneIndex = 0;
                deployedUnits[index].ViewData.CellIndex = index;
