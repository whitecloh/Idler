...
{
    public sealed class DeployCardSystem : IEcsInitSystem, IEcsRunSystem
    {
        ...
        public DeployCardSystem(RunEntityIndex runEntityIndex, OwnedUnitIndex ownedUnitIndex)
        {
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            foreach (var requestEntity in _requestFilter)
            {
                ...
                var requestedCardRuntimeId = _requestPool.Get(requestEntity).HandCardRuntimeId;
                var handCardEntity = -1;
                foreach (var candidateEntity in _handCardFilter)
                {
                    if (_handCardPool.Get(candidateEntity).HandCardRuntimeId == requestedCardRuntimeId)
                    {
                        handCardEntity = candidateEntity;
                        break;
                    }
                }
